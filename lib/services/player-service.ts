...
import type { PlayerCSVImport, TierType, DivisionType } from "@/types/tournament";
...
export async function createPlayer(data: {
    ...
    const [newPlayer] = await db.insert(player).values({
        ...
        league_points: data.league_points || 0,
...
export async function updatePlayer(
    ...
    if (data.league_points !== undefined) updateData.league_points = data.league_points;
