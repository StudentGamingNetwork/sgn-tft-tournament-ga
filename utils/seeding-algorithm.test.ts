...
describe('seedingAlgorithm', () => {
    ...
    describe('comparePlayers', () => {
        ...
        it('classe LP plus élevé avant LP plus bas (même tier)', () => {
    ...
    describe('assignSeeds', () => {
        ...
        it('trie correctement 8 joueurs par tier et LP', () => {
            const players: SeedingInput[] = [
                {
                    player_id: '5',
                    name: 'P5',
            ...
            expect(seeded[2].player_id).toBe('4'); // Master 500 LP
            expect(seeded[3].player_id).toBe('3'); // Master 200 LP
            expect(seeded[4].player_id).toBe('5'); // Diamond 100 LP
        });
