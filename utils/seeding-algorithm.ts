 ...
 * Sorts players by tier and LP to assign global seeds
 */

import type { TierType, SeedingInput, SeededPlayer } from "@/types/tournament";
 ...
 * 2. LP (descending: higher LP is better)
 * 3. Name (alphabetical, for deterministic ties)
 */
export function comparePlayers(a: SeedingInput, b: SeedingInput): number {
    ...
    // Same tier, compare by LP (higher = better, so reverse order)
